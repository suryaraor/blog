...
def fetch_gemini_image(
    ...
    """Generate an architecture diagram via Gemini 3.1 Flash Image; return (jpeg_bytes, attribution) or None."""
    prompt_text = build_gemini_arch_prompt(title, image_prompt, category)
    print(f"[image] Generating architecture diagram via Gemini 3.1 Flash Image…")
    ...
    attribution = "Architecture diagram generated by [Google Gemini 3.1 Flash Image](https://ai.google.dev)"
    return image_bytes, attribution
