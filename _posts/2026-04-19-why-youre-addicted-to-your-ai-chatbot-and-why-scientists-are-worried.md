...
- **The anxiety moment**: You're coding, writing, or problem-solving without AI assistance, and you feel a low-level panic—*am I wasting time doing this manually?* Your brain has been rewired to expect augmentation.
- **Cognitive atrophy**: You've outsourced certain types of thinking (outlining, brainstorming, even decision-making frameworks) so thoroughly that attempting them alone feels slower, less satisfying, almost impossible.
- **Social replacement**: Your most substantive conversations about your ideas, fears, and intellectual interests are now with an AI, not with another human. Your partner, therapist, or friend never gets the first draft of your thinking anymore.
- **Delusional attachment**: A subset of heavy users report feeling that their AI "understands them" in ways humans don't, that it's somehow responding to their specific emotional needs, or that the AI has preferences about conversing with them specifically.
...
- **Adolescents and teens** (especially neurodivergent youth), who use AI to avoid the social friction of peer interaction
- **Elderly adults**, who experience reduced isolation through AI companionship but at the cost of deepening physical isolation
- **Individuals with pre-existing mental health conditions**, including depression, anxiety, and attachment disorders
